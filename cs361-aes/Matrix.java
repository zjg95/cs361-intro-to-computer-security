/*
	Class for matrix operations. Everything in this
	file is written by Dr. Young. Some minor
	modifications were made. #ForeverYoung
*/
...
public class Matrix {
    ...
    public static void mixColumn2 (int[][] st, int c) {
    ...
    public static void invMixColumn2 (int[][] st, int c) {
		int a[] = new int[4];
